...
from fenom.control import homeWindow
...
try: unwanted_tags = jsloads(homeWindow.getProperty('pov_lite_unwanted'))['unwanted']
...
def check_foreign_audio():
	return home_getProperty('pov_lite_fs_filterless_search') != 'true'
