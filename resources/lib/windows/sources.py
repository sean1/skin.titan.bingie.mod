...
extra_info_str, browse_pack_str, cloud_str = ls(32605), ls(32746), ls(32016)
...
check_str = '[B]CHECK CACHE STATUS[/B]'
cache_str = ('CACHED', 'CACHED [B]%s[/B]')
...
class ResultsContextMenu(BaseDialog):
	...
	def make_menu(self):
		...
		if 'realdebrid' in cache_provider:
