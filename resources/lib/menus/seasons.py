	...
	def build_season_list(self, params):
		...
		for item in season_data:
			try:
				...
				props.update(media_percentage_properties(item_get('vote_average')))
				...
				if KODI_VERSION < 20:
					...
					listitem.setCast(resized_cast(show.cast))
				else:
					...
					videoinfo.setCast(make_cast_list(resized_cast(show.cast)))
